...
fn bench_case_transformations(c: &mut Criterion) {
    ...
    for input in [SHORT_INPUT, MEDIUM_INPUT, LONG_INPUT] {
        ...
        group.bench_with_input(
            BenchmarkId::new("randomize_capitalization", size),
            input,
            |b, i| b.iter(|| randomize_capitalization(black_box(i))),
        );
...
fn bench_encoding_transformations(c: &mut Criterion) {
    ...
    for input in [SHORT_INPUT, MEDIUM_INPUT, LONG_INPUT] {
        ...
        group.bench_with_input(
            BenchmarkId::new("html_entity_encode", size),
            input,
            |b, i| b.iter(|| html_entity_encode(black_box(i))),
        );
...
fn bench_obfuscation_transformations(c: &mut Criterion) {
    ...
    for input in [SHORT_INPUT, MEDIUM_INPUT, LONG_INPUT] {
        ...
        group.bench_with_input(
            BenchmarkId::new("double_characters", size),
            input,
            |b, i| b.iter(|| double_characters(black_box(i))),
        );
        ...
        group.bench_with_input(
            BenchmarkId::new("whitespace_padding", size),
            input,
            |b, i| b.iter(|| whitespace_padding(black_box(i))),
        );
    }
...
fn bench_unicode_transformations(c: &mut Criterion) {
    ...
    for input in [SHORT_INPUT, MEDIUM_INPUT, LONG_INPUT] {
        ...
        group.bench_with_input(
            BenchmarkId::new("homoglyph_substitution", size),
            input,
            |b, i| b.iter(|| homoglyph_substitution(black_box(i))),
        );

        group.bench_with_input(
            BenchmarkId::new("unicode_variations", size),
            input,
            |b, i| b.iter(|| unicode_variations(black_box(i))),
        );
        ...
        group.bench_with_input(
            BenchmarkId::new("unicode_normalize_variants", size),
            input,
            |b, i| b.iter(|| unicode_normalize_variants(black_box(i))),
        );
    }
...
fn bench_bot_detection_transformations(c: &mut Criterion) {
    ...
    group.bench_function("random_user_agent", |b| b.iter(|| random_user_agent()));
